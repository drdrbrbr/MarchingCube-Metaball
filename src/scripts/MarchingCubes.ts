...
export class MarchingCubes {
  ...
  constructor(renderer: THREE.WebGLRenderer, scene:THREE.Scene, camera: THREE.Camera) {
    ...
    this.material = new THREE.RawShaderMaterial({
      ...
      uniforms: {
        ...
        sphereColor: { value: new THREE.Color(this.sphereColor[0] / 255, this.sphereColor[1] / 255, this.sphereColor[2] / 255) },
        time: { value: 0 },
        effectValue: { value: 0 },
  ...
  initDatGUI() {
    ...
    .onFinishChange((value: number)=> { this.updateMargingCubesSpace(); });

    this.gui.add(this, 'numSpheres', 4, 50, this.numSpheres).step(1)
    .onFinishChange((value: number)=> { this.updateNumSpheres(); });
    ...
    this.gui.addColor(this, 'sphereColor' , 255)
    .onChange((value: number[])=> {
  ...
  update(time: number) {
    this.material.uniforms.time.value = time/2;
